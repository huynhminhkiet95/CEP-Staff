...
class UpdateInformationUser {
  ...
  UpdateInformationUser({this.ngay, this.makhachhang, this.tblThongtinthaydoi, this.urlHinhanh, this.usernameNhanvien, this.ngaycapnhatNhanvien, this.chinhanhid, this.checksum});

  UpdateInformationUser.fromJson(Map<String, dynamic> json) {
    if(json["ngay"] is String)
      this.ngay = json["ngay"];
    if(json["makhachhang"] is String)
      this.makhachhang = json["makhachhang"];
    if(json["tbl_thongtinthaydoi"] is List)
      this.tblThongtinthaydoi = json["tbl_thongtinthaydoi"]==null ? null : (json["tbl_thongtinthaydoi"] as List).map((e)=>TblThongtinthaydoi.fromJson(e)).toList();
    if(json["url_hinhanh"] is List)
      this.urlHinhanh = json["url_hinhanh"]==null ? null : (json["url_hinhanh"] as List).map((e)=>UrlHinhanh.fromJson(e)).toList();
  ...
  Map<String, dynamic> toJson() {
    ...
    if(this.tblThongtinthaydoi != null)
      data["tbl_thongtinthaydoi"] = this.tblThongtinthaydoi.map((e)=>e.toJson()).toList();
...
class UrlHinhanh {
  ...
  UrlHinhanh.fromJson(Map<String, dynamic> json) {
    ...
    if(json["url_hinhanh"] is String)
      this.urlHinhanh = json["url_hinhanh"];
    if(json["ismattruoc"] is bool)
      this.ismattruoc = json["ismattruoc"];
  }
...
class TblThongtinthaydoi {
  ...
  TblThongtinthaydoi({this.loaithongtinId, this.giatriCu, this.giatriMoi, this.ngaycap, this.noicap});

  TblThongtinthaydoi.fromJson(Map<String, dynamic> json) {
    if(json["loaithongtin_id"] is int)
      this.loaithongtinId = json["loaithongtin_id"];
    if(json["giatri_cu"] is String)
      this.giatriCu = json["giatri_cu"];
    if(json["giatri_moi"] is String)
      this.giatriMoi = json["giatri_moi"];
    if(json["ngaycap"] is String)
      this.ngaycap = json["ngaycap"];
    if(json["noicap"] is String)
      this.noicap = json["noicap"];
  }
