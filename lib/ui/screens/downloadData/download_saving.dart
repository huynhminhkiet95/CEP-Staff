...
class DownloadSaving extends StatefulWidget {
  DownloadSaving({Key key}) : super(key: key);

  @override
  _DownloadSavingState createState() => _DownloadSavingState();
}

class _DownloadSavingState extends State<DownloadSaving> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: customScrollViewSliverAppBarForDownload(
          allTranslations.text("DownloadSavingAdvisory"),
          <Widget>[
            Container(
