  ...
  Widget build(BuildContext context) {
    return getWrapper(PageView.builder(
      ...
      itemBuilder: (BuildContext context, int i) {
        // i = i + globalPermission.pageActive;
        //  int index2;
        int index = _getRealIndex(
            i + widget.initialPage, widget.realPage, widget.items.length);
        // if (globalPermission.getIsPageActive == true) {

        //   if (globalPermission.getIscheckluot == true) {
        //       if (index == 1)
        //         index2 =  globalPermission.getpageActive + 1;
        ...
        //   if (index2 != null) {
        //     index  = index2;
        //     globalPermission.setpageActive = index;
        //   }
        //   else
        //   {
        //      index =  globalPermission.getpageActive;
        //   }
