class Strings {
  static final appTitle = "Igls Mobile";
  ...
  static final String profileImageUri = 'https://res.cloudinary.com/vemarav/' +
      'image/upload/c_scale,w_100/v1547797121/' +
      'aravind-vemula-nobg.png';
