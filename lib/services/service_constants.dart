mixin ServiceName {
  ...
  static const String GetSurveyInfoHistory =
      "api/NhanVien/LayLichSuKhaoSatChoTBDD";
  static const String GetComboBoxValueChoTBD =
      "api/NhanVien/GetComboBoxValueChoTBĐ";
  static const String GetDataCommunityDevelopment =
      "api/NhanVien/XuatPTCDXuongDiDong";
  static const String UpdateSurveyInfo = "api/NhanVien/CapNhatThongTinKhaoSat";
  static const String UpdateCommunityDevelopmentInfo =
      "api/NhanVien/CapNhatPhatTrienCongDong";
  static const String UpdateInfoCustomer =
      "api/NhanVien/CapNhatThongTinKhachHang";
